...
import 'package:deogracias/interface/stream_assistance.dart';
...
class AssistancesDesClients extends StatefulWidget {
  AssistancesDesClients({super.key});

  @override
  State<AssistancesDesClients> createState() => _AssistancesDesClientsState();
}

class _AssistancesDesClientsState extends State<AssistancesDesClients> {
  bool affiche = false;
  ...
  Widget build(BuildContext context) {
    final assistances = Provider.of<List<Assistances>>(context);
