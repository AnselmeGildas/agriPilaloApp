...
class StreamVagueSignalerOeuf extends StatelessWidget {
  const StreamVagueSignalerOeuf({super.key, required this.vague_uid});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: SignalerOeufCasse(vague_uid: vague_uid),
    );
  }
}
