...
import 'package:deogracias/interface/stream_de_vente_de_fiente_user.dart';
...
class _VenteDeFientesUserState extends State<VenteDeFientesUser> {
  String _search = "";
                  ...
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => StreamVenteFienteUser(
