...
class StreamVagueSignalerPOussinMortRetablie extends StatelessWidget {
  const StreamVagueSignalerPOussinMortRetablie(
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: SignalerPoussinMortRetabli(vague_uid: vague_uid),
    );
  }
}
