...
class StreamVagueStockRechargerOeuf extends StatelessWidget {
  const StreamVagueStockRechargerOeuf({super.key, required this.vague_uid});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: StockOeufs(vague_uid: vague_uid),
    );
  }
}
