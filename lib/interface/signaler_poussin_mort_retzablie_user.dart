...
class _SignalerPoussinMortRetabliUserState
    extends State<SignalerPoussinMortRetabliUser> {
  bool affiche = false;
          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                  alignment: Alignment.centerLeft,
                  child: Text(
                    "Ces poussins sont ils rétablis ou morts ? ",
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 18,
                        fontWeight: FontWeight.bold),
                  ...
                  onPressed: () async {
                    try {
                      ...
                      if (nombre.text.isEmpty) {
                        ...
                        if (mort) {
                          if (poussin.nombre_malade < _nombre_saisi) {
                            provider.affiche_false();
                            _speak(
                                "Nombre insuffisant. Le nombre saisi est strictement supérieur au nombre malade de poussins signalé. Il y a que " +
                                    poussin.nombre_malade.toString() +
                                    " poussins malades");
                            final snakbar = SnackBar(
                              content: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                                  "Nombre isnuffisant. Le nombre saisi est strictement supérieur au nombre malades de poussins signalés",
                                  textAlign: TextAlign.center,
                                  style: GoogleFonts.lato(
                                      color: Colors.white,
                                      fontSize: 22,
                          ...
                          if (!mort &&
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(snakbar);
                          } else if (_nombre_saisi > poussin.nombre_malade) {
                            provider.affiche_false();
                            _speak(
                                "Nombre insuffisant. Le nombre saisi est strictement supérieur au nombre malade de poussins signalé. Il y a que " +
                                    poussin.nombre_malade.toString() +
