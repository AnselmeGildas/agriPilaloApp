...
class StreamVagueVenteOeufTableUser extends StatelessWidget {
  const StreamVagueVenteOeufTableUser({super.key, required this.vague_uid});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: VenteOeufTableUser(vague_uid: vague_uid),
    );
  }
}
