...
class StreamVagueSignalerPoussin extends StatelessWidget {
  const StreamVagueSignalerPoussin({super.key, required this.vague_uid});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: SignalerPoussin(vague_uid: vague_uid),
    );
  }
}
