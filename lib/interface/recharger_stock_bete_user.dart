...
class _RechargerStockDuBeteUserState extends State<RechargerStockDuBeteUser> {
  String nombre = "";
  ...
  Widget build(BuildContext context) {
    ...
    final provider = Provider.of<ProviderRechargerStockBete>(context);
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                    ...
                    child: Text(
                      "Quel nombre de " + bete.nom + " voulez vous ajouter ?",
                      style: GoogleFonts.alike(
                          color: Colors.white,
                          fontSize: 18,
                          fontWeight: FontWeight.bold),
                      ...
                      try {
                        ...
                        if (_nombre.text.isEmpty || _nombre_bete <= 0) {
                          ...
                          await FirebaseFirestore.instance
                              ...
                              .update({
                            "nombre_restant":
                                bete.nombre_restant + _nombre_bete,
                            'nombre_initial':
                                bete.nombre_initial + _nombre_bete,
