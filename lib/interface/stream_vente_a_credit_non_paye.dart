...
import 'package:deogracias/interface/vente_a_credit_non_paye.dart';
...
class StreamVenteACreditNonPaye extends StatelessWidget {
  const StreamVenteACreditNonPaye(
      {super.key,
