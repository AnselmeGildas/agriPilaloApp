...
import 'package:deogracias/interface/signaler_bete_mmort_retablie.dart';
import 'package:deogracias/modele/betes.dart';
import 'package:deogracias/modele/budget_tiers.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class StreamSignalerBeteMortRetablie extends StatelessWidget {
  const StreamSignalerBeteMortRetablie(
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: SignalerBeteMortRetablie(
        vague_uid: vague_uid,
      ),
    );
  }
