...
class StreamVagueSignalerBetesUser extends StatelessWidget {
  const StreamVagueSignalerBetesUser({super.key, required this.vague_uid});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: SignalerBetesUser(vague_uid: vague_uid),
    );
  }
}
