...
import 'package:deogracias/interface/liste_des_ventes_a_credits_non_payes.dart';
...
import 'package:deogracias/interface/signaler_betes_morts_retablis.dart';
import 'package:deogracias/interface/signaler_poussin_mort_retablie.dart';
                      ...
                      child: TextButton(
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => HistoriqueVentesBetes(),
                                ));
                          },
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      ...
                      child: TextButton(
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => VentesACreditPayes(),
                                ));
                          },
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
