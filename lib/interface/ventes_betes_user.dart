...
import 'package:deogracias/interface/stream_vente_bete_user.dart';
...
class _VenteDesBetesUserState extends State<VenteDesBetesUser> {
  String _search = "";
                  ...
                  ? ListTile(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => StreamVenteBeteUser(
                                bete_uid: bete.uid,
                                vague_uid: vague.uid,
                              ),
                            ));
