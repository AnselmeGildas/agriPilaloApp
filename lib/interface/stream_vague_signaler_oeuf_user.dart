...
class StreamVagueSignalerOeufUser extends StatelessWidget {
  const StreamVagueSignalerOeufUser({super.key, required this.vague_uid});
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: SignalerOeufCasseUser(vague_uid: vague_uid),
    );
  }
}
