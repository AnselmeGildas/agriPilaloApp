...
class StreamVagueHistoriquePremiereDate extends StatelessWidget {
  const StreamVagueHistoriquePremiereDate(
      {super.key, required this.vague_uid, required this.premiere_date});
