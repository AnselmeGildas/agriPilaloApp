...
class StreamVagueSignalerPOussinMortRetablieUser extends StatelessWidget {
  const StreamVagueSignalerPOussinMortRetablieUser(
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: SignalerPoussinMortRetabliUser(vague_uid: vague_uid),
    );
  }
}
