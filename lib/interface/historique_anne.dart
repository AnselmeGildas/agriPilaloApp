...
class HistoriqueAnnee extends StatelessWidget {
  const HistoriqueAnnee(
      {super.key, required this.premiere_date, required this.vague_uid});
  ...
  Widget build(BuildContext context) {
    ...
    list_vente_oeuf.forEach((element) {
      if (element.annee == this.premiere_date) {
        nombre_oeuf++;
                              ...
                              SingleChildScrollView(
                                ...
                                child: DataTable(
                                    ...
                                    rows: betes.map((bete) {
                                      ...
                                      list_vente_betes.forEach((element) {
                                        if (element.annee == premiere_date &&
