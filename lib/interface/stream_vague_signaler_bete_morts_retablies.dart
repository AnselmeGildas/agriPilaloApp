...
class StreamVagueSignalerBeteMortsRetablie extends StatelessWidget {
  const StreamVagueSignalerBeteMortsRetablie({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: SignalerBetesMortRetablie(vague_uid: vague_uid),
    );
  }
}
